...
from textual.widgets import Label, ListView, ListItem, Button, Static, Collapsible, Markdown
from textual.containers import Container, Vertical, Horizontal, VerticalScroll
from .base import ModalScreen, Binding
            ...
            for server_name, info in status.items():
                ...
                if info["connected"]:
                    ...
                    if client and client.tools:
                        ...
                        tools_widgets.append(Label("  No tools available", classes="no-tools"))
                else:
                    tools_widgets.append(Label("  Not connected", classes="server-disconnected"))

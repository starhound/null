...
CATALOG: list[CatalogEntry] = [
    ...
    CatalogEntry(
        ...
        command="uvx",
        args=["mcp-server-sentry", "--auth-token", "YOUR_AUTH_TOKEN"],
    ...
    CatalogEntry(
        name="azure-devops",
        description="Azure DevOps repos, pipelines, work items",
        command="npx",
        args=["-y", "mcp-server-azuredevops", "YOUR_ORG_URL"],
        env_keys=["AZURE_DEVOPS_TOKEN"],
        category="development",
        url="https://github.com/microsoft/azure-devops-mcp",
    ),
    CatalogEntry(
        name="agentops",
        description="AgentOps AI agent observability",
        command="npx",
        args=["-y", "agentops-mcp"],
        env_keys=["AGENTOPS_API_KEY"],
        category="development",
    ...
    CatalogEntry(
        name="algolia",
        description="Algolia search and indexing",
        command="npx",
        args=["-y", "@algolia/mcp-server"],
        env_keys=["ALGOLIA_APP_ID", "ALGOLIA_API_KEY"],
        category="search",
        url="https://github.com/algolia/mcp-node",
    ),
    CatalogEntry(
        name="auth0",
        description="Auth0 identity management",
        command="npx",
        args=["-y", "@auth0/mcp-server-auth0"],
        env_keys=["AUTH0_DOMAIN", "AUTH0_CLIENT_ID", "AUTH0_CLIENT_SECRET"],
        category="security",
    ...
    CatalogEntry(
        name="browserstack",
        description="BrowserStack testing",
        command="npx",
        args=["-y", "@browserstack/mcp-server"],
        env_keys=["BROWSERSTACK_USERNAME", "BROWSERSTACK_ACCESS_KEY"],
        category="development",
    ...
    CatalogEntry(
        ...
        env_keys=["BUILDKITE_API_TOKEN"],
        category="development",
        url="https://github.com/buildkite/mcp-server",
    ),
    CatalogEntry(
        name="calcom",
    ...
    CatalogEntry(
        ...
        env_keys=["CODACY_API_TOKEN"],
        category="development",
        url="https://github.com/codacy/codacy-mcp-server",
    ),
    CatalogEntry(
        name="aiven",
        description="Aiven cloud data platform",
        command="uvx",
        args=["mcp-aiven"],
        env_keys=["AIVEN_TOKEN"],
        category="cloud",
    ...
    CatalogEntry(
        name="bitrise",
        description="Bitrise mobile CI/CD",
        command="uvx",
        args=["bitrise-mcp"],
        env_keys=["BITRISE_ACCESS_TOKEN"],
        category="development",
        url="https://github.com/bitrise-io/bitrise-mcp",
    ),
    CatalogEntry(
        name="axiom",
        description="Axiom observability and logging",
        command="uvx",
        args=["mcp-server-axiom"],
        env_keys=["AXIOM_TOKEN", "AXIOM_ORG_ID"],
        category="development",
        url="https://github.com/axiomhq/mcp-server-axiom",
    ),
    CatalogEntry(
        name="cloudbees",
        description="CloudBees CI/CD platform",
        command="npx",
        args=["-y", "@cloudbees/mcp-server"],
        env_keys=["CLOUDBEES_API_TOKEN", "CLOUDBEES_URL"],
        category="development",
        url="https://github.com/cloudbees/mcp-server",
    ),
    CatalogEntry(
        name="conductor",
        description="Orkes Conductor orchestration",
        command="npx",
        args=["-y", "@conductor-oss/mcp-server"],
        env_keys=[
        ...
        category="development",
        url="https://github.com/conductor-oss/mcp-server",
    ),
    CatalogEntry(
        name="codelogic",
        description="CodeLogic database analysis",
        command="npx",
        args=["-y", "mcp-server-codelogic"],
        env_keys=["CODELOGIC_API_KEY"],
        category="development",
        url="https://github.com/codelogic/mcp-server-codelogic",
    ),
    CatalogEntry(
        name="composio",
        description="Composio tool integration",
        command="npx",
        args=["-y", "composio-mcp"],
        env_keys=["COMPOSIO_API_KEY"],
        category="development",
        url="https://github.com/ComposioHQ/composio-mcp",
    ),
    CatalogEntry(
        name="archbee",
        description="Archbee documentation",
        command="npx",
        args=["-y", "@archbee/mcp"],
        env_keys=["ARCHBEE_API_KEY"],
        category="development",
        url="https://github.com/archbee/mcp",
    ),
    CatalogEntry(
        name="alttester",
        description="AltTester game testing",
        command="npx",
        args=["-y", "alttester-mcp"],
        env_keys=[],
        category="development",
        url="https://github.com/alttester/alttester-mcp",
    ),
    CatalogEntry(
        name="appium",
        description="Appium mobile automation",
        command="npx",
        args=["-y", "appium-mcp-server"],
        env_keys=[],
        category="development",
        url="https://github.com/appium/appium-mcp-server",
    ),
    CatalogEntry(
        name="astra-db",
        description="DataStax Astra DB (Cassandra)",
        command="npx",
        args=["-y", "astra-db-mcp"],
        env_keys=["ASTRA_DB_TOKEN", "ASTRA_DB_ENDPOINT"],
        category="database",
        url="https://github.com/datastax/astra-db-mcp",
    ),
    CatalogEntry(
        name="baserow",
        description="Baserow database platform",
        command="uvx",
        args=["mcp-server-baserow"],
        env_keys=["BASEROW_TOKEN"],
        category="database",
        url="https://github.com/baserow/mcp-server-baserow",
    ),
    CatalogEntry(
        name="cloudera",
        description="Cloudera Data Platform",
        command="uvx",
        args=["mcp-server-cloudera"],
        env_keys=["CLOUDERA_USER", "CLOUDERA_PASSWORD"],
        category="database",
        url="https://github.com/cloudera/mcp-server-cloudera",
    ),
    CatalogEntry(
        name="doris",
        description="Apache Doris analytics",
        command="uvx",
        args=["mcp-server-doris"],
        env_keys=["DORIS_USER", "DORIS_PASSWORD", "DORIS_HOST"],
        category="database",
        url="https://github.com/apache/doris-mcp",
    ),
    CatalogEntry(
        name="pinot",
        description="Apache Pinot analytics",
        command="uvx",
        args=["mcp-server-pinot"],
        env_keys=["PINOT_CONTROLLER_URL"],
        category="database",
        url="https://github.com/apache/pinot-mcp",
    ),
    CatalogEntry(
        name="alkemi",
        description="Alkemi on-chain data",
        command="npx",
        args=["-y", "alkemi-mcp"],
        env_keys=["ALKEMI_API_KEY"],
        category="database",
        url="https://github.com/alkemi-network/alkemi-mcp",
    ),
    CatalogEntry(
        name="bauplan",
        description="Bauplan data lake",
        command="uvx",
        args=["mcp-server-bauplan"],
        env_keys=["BAUPLAN_API_KEY"],
        category="database",
        url="https://github.com/bauplan/mcp-server-bauplan",
    ),
    CatalogEntry(
        name="coingecko",
        description="CoinGecko crypto market data",
        command="npx",
    ...
    CatalogEntry(
        name="coinstats",
        description="CoinStats crypto portfolio",
        command="npx",
        args=["-y", "mcp-server-coinstats"],
        env_keys=["COINSTATS_API_KEY"],
        category="finance",
        url="https://github.com/coinstats/mcp-server-coinstats",
    ),
    CatalogEntry(
        name="cashfree",
        description="Cashfree payments",
        command="npx",
        args=["-y", "mcp-server-cashfree"],
        env_keys=["CASHFREE_CLIENT_ID", "CASHFREE_CLIENT_SECRET"],
        category="finance",
        url="https://github.com/cashfree/mcp-server-cashfree",
    ),
    CatalogEntry(
        name="bitnovo",
        description="Bitnovo crypto payments",
        command="npx",
        args=["-y", "mcp-server-bitnovo"],
        env_keys=["BITNOVO_API_KEY"],
        category="finance",
        url="https://github.com/bitnovo/mcp-server-bitnovo",
    ),
    CatalogEntry(
        name="brightdata",
        description="Bright Data web scraping",
        command="npx",
        args=["-y", "@brightdata/mcp-server"],
        env_keys=["BRIGHTDATA_API_KEY"],
        category="web",
        url="https://github.com/brightdata/mcp-server",
    ),
    CatalogEntry(
        name="builtwith",
        description="BuiltWith technology profiler",
        command="npx",
        args=["-y", "builtwith-mcp"],
        env_keys=["BUILTWITH_API_KEY"],
        category="web",
        url="https://github.com/builtwith/builtwith-mcp",
    ),
    CatalogEntry(
        name="cloudsway",
        description="Cloudsway cloud search",
        command="npx",
        args=["-y", "cloudsway-mcp"],
        env_keys=["CLOUDSWAY_API_KEY"],
        category="web",
        url="https://github.com/cloudsway/cloudsway-mcp",
    ),
    CatalogEntry(
        name="burpsuite",
        ...
        env_keys=["BURP_API_KEY"],
        category="security",
        url="https://github.com/PortSwigger/mcp-server",
    ),
    CatalogEntry(
        name="boostsecurity",
        description="BoostSecurity supply chain security",
        command="npx",
        args=["-y", "boost-mcp"],
        env_keys=["BOOST_API_TOKEN"],
        category="security",
        url="https://github.com/boostsecurityio/boost-mcp",
    ),
    CatalogEntry(
        name="authenticator",
        description="2FA/TOTP authenticator",
        command="uvx",
        args=["authenticator-mcp"],
        env_keys=[],
        category="security",
        url="https://github.com/authenticator/authenticator-mcp",
    ),
    CatalogEntry(
        name="anytype",
        description="Anytype local-first notes",
        command="npx",
        args=["-y", "anytype-mcp"],
        env_keys=[],
        category="productivity",
        url="https://github.com/anytypeio/anytype-mcp",
    ),
    CatalogEntry(
        name="boldsign",
        description="BoldSign e-signatures",
        command="npx",
        args=["-y", "boldsign-mcp"],
        env_keys=["BOLDSIGN_API_KEY"],
        category="productivity",
        url="https://github.com/boldsign/boldsign-mcp",
    ),
    CatalogEntry(
        name="clicksend",
        description="ClickSend SMS and communications",
        command="npx",
        args=["-y", "clicksend-mcp"],
        env_keys=["CLICKSEND_USERNAME", "CLICKSEND_API_KEY"],
        category="communication",
        url="https://github.com/clicksend/clicksend-mcp",
    ),
    CatalogEntry(
        name="phoenix",
        description="Arize Phoenix LLM traces",
        command="uvx",
        args=["phoenix-mcp"],
        env_keys=["PHOENIX_API_KEY", "PHOENIX_COLLECTOR_ENDPOINT"],
        category="ai",
        url="https://github.com/Arize-ai/phoenix-mcp",
    ),
    CatalogEntry(
        name="opik",
        description="Comet Opik LLM evaluation",
        command="uvx",
        args=["opik-mcp"],
        env_keys=["OPIK_API_KEY"],
        category="ai",
        url="https://github.com/comet-ml/opik-mcp",
    ),
    CatalogEntry(
        name="atla",
        description="Atla AI evaluator",
        command="uvx",
        args=["atla-mcp"],
        env_keys=["ATLA_API_KEY"],
        category="ai",
        url="https://github.com/atla-ai/atla-mcp",
    ),
    CatalogEntry(
        name="contentful",
        ...
        env_keys=["CONTENTFUL_MANAGEMENT_TOKEN", "CONTENTFUL_SPACE_ID"],
        category="cms",
        url="https://github.com/contentful/contentful-mcp-server",
    ),
    CatalogEntry(
        name="heroku",
        description="Heroku platform management",
        command="npx",
        args=["-y", "@heroku/mcp-server"],
        env_keys=["HEROKU_API_KEY"],
        category="cloud",
        url="https://github.com/heroku/heroku-mcp-server",
    ),
    CatalogEntry(
        name="mapbox",
        description="Mapbox maps and location services",
        command="npx",
        args=["-y", "@mapbox/mcp-server"],
        env_keys=["MAPBOX_ACCESS_TOKEN"],
        category="utility",
        url="https://github.com/mapbox/mcp-server",
    ),
    CatalogEntry(
        name="dynatrace",
        description="Dynatrace observability",
        command="npx",
        args=["-y", "@dynatrace-oss/dynatrace-mcp-server"],
        env_keys=["DYNATRACE_URL", "DYNATRACE_API_TOKEN"],
        category="monitoring",
        url="https://github.com/dynatrace-oss/dynatrace-mcp",
    ),
    CatalogEntry(
        name="sap-fiori",
        description="SAP Fiori tools",
        command="npx",
    ...
    CatalogEntry(
        name="sap-ui5",
        description="SAP UI5 development",
        command="npx",

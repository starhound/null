...
class SSHSession:
    def __init__(self, hostname: str, port: int = 22, username: str = None, 
                 password: str = None, key_path: str = None, tunnel: Optional['SSHSession'] = None):
    ...
    async def start_shell(self, term_type: str = 'xterm-256color', 
                          cols: int = 80, lines: int = 24,
                          input_handler: Optional[Callable[[str], None]] = None):
